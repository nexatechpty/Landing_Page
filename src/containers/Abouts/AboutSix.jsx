  ...
  const TABDATA = [
    {
      ...
      text: "We create impactful digital marketing strategies that amplify brand visibility, engage target audiences, and drive measurable growth through SEO, social media, and content.",
      feature: [
        "Fast Growing Sells",
